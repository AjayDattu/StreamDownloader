...
function LinkP() {
  ...
  return (
    <div className="relative flex justify-center items-center h-screen">
      {contextHolder}
      {/* Content */}
      <div className="flex flex-col justify-center items-center space-y-6 p-8 relative z-10 w-full">
        <label className="text-black text-5xl font-semibold text-lg" htmlFor="youtube-link">
          YouTube link here
        </label>
